        ...
        <tr bgcolor="#FFFFFF">
          <td colspan="9" align="center">
          		<table border="0" width="100%">
          			<tr>
          				<td align="left">     
                        <form  action='<%=basePath%>/dms/med_list' method="get" onsubmit="" class="blur_form">
		  ...
		  <c:forEach items="${page.rows}" var="medicine">
			  <tr bgcolor="#FFFFFF">
				  ...
				  <td><a href="<%=basePath%>/dms/med_update/${medicine.id}">修改</a>&nbsp; <a href="<%=basePath%>/dms/deleteMedicine/${medicine.id}">删除</a> <a href="<%=basePath%>/dms/checkMedicine/${medicine.id}">查看</a></td>
		  </tr>
		  </c:forEach>
	        	<tr bgcolor="#FFFFFF">		        
		          <td colspan="9" align="right">
		          	<table border="0" width="100%">
		          		<tr>		          			
		          			<td align="right">
								<div class="paging">
									<pg:page url="${pageContext.request.contextPath}/dms/med_list.action" />
								</div>
		          			</td>
		          		</tr>
		          	</table>
